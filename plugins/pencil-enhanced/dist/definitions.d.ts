...
export interface PencilEnhancedPlugin {
     ...
     */
    startHandwritingSession(options?: {
        locale?: string;
    }): Promise<{
        text: string;
    }>;
    ...
    recognizeInkImage(options: {
        imageBase64: string;
        locale?: string;
    }): Promise<{
        text: string;
    }>;
    addListener(eventName: "pencilDoubleTap", listenerFunc: (payload: PencilDoubleTapPayload) => void): Promise<PluginListenerHandle>;
    addListener(eventName: "pencilSqueeze", listenerFunc: (payload: PencilSqueezePayload) => void): Promise<PluginListenerHandle>;
}
